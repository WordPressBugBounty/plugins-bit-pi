...
use BitApps\Pi\HTTP\Controllers\CustomMachineController;
...
Route::group(
    function (): void {
        ...
        Route::post('node/clone', [NodeController::class, 'cloneNode']);
        ...
        Route::post('webhooks/{webhook}/update-title', [WebhookController::class, 'updateTitle']);
